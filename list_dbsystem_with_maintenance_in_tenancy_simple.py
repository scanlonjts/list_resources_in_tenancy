...
# Load compartments
##########################################################################
def identity_read_compartments(identity, tenancy_id):
    ...
    try:
        ...
        croot = oci.identity.models.Compartment()
        croot.name = "root"
        croot.id = tenancy_id
        compartments.append(croot)
...
try:
    ...
    print("Tenant Id   : " + tenancy_id)
    print("")

    compartments = identity_read_compartments(identity, tenancy_id)
...
for region_name in regions:
    ...
    for compartment in compartments:
        ...
        if compartment.id != tenancy_id and compartment.lifecycle_state != oci.identity.models.Compartment.LIFECYCLE_STATE_ACTIVE:
            continue
